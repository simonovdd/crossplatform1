...
namespace simonov.models
{
    ...
    {
        public static string Issuer => "simonov";
        public static string Audience => "APIclients";
        public static int LifetimeInYears => 1;
        public static SecurityKey SigningKey => new SymmetricSecurityKey(Encoding.ASCII.GetBytes("qwertyuiop148822814882281488lul"));
